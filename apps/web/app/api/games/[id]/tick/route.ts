 ...
 * resolve whatever expired. Any seated player, or the host, may send it; it
 * applies no action of theirs. Anyone else gets a 403 from actOnGame. This is
 * what keeps a table moving on a plan without a minute cron.
 */
